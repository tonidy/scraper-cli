...
import com.tonidy.scraper.CLI.Validator.TotalProductsValidator;
...
public class Settings {
    ...
    @Parameter(names = { "-t",
            "--total" }, description = "Number of total products", validateWith = TotalProductsValidator.class)
    ...
    @Parameter(names = { "-f",
            "--fileType" }, description = "Output file type format", converter = FileTypeConverter.class)
